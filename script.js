...
document.addEventListener('DOMContentLoaded', function() {
  var albumCoverElement = document.querySelector('.simp-album i'); // Replace '.simp-album' with the actual selector
  
  if (albumCoverElement) {
    albumCoverElement.remove(); // Remove the identified element
  }
});
